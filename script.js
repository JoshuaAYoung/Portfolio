...
function generateProject(index) {
  return `<div class="project" id="project">
    ...
    <div class="projectDescription">
        ...
        <p class="projectLinks"><a href="${PROJECTS[index].code}" target="_blank" class="projectLinks">CODE</a><span class="projectBullet"><img src="./images/hexagon.svg" alt="gear logo" class="logoBreak"></span><a href="${PROJECTS[index].demo}" target="_blank" class="projectLinks">DEMO</a>
    </div>
